...
namespace TheWorld.Migrations
{
    ...
    [Migration("20171206072225_JobTitlesTable")]
    partial class JobTitlesTable
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TheWorld.Models.JobTitle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TheWorld.Models.Stop", b =>
                {
                    b.HasOne("TheWorld.Models.JobTitle", "JobTitle")
                        .WithMany()
